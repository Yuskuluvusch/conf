...
$sql[] = 'CREATE TABLE IF NOT EXISTS `' . _DB_PREFIX_ . 'configurator` (
    ...
    `use_combination` TINYINT(1) DEFAULT 0,
...
$sql[] = 'CREATE TABLE IF NOT EXISTS `' . _DB_PREFIX_ . 'configurator_step` (
    ...
    `unit_qty_step` TINYINT(1) UNSIGNED NULL DEFAULT 0,
    ...
    `delivery_impact` TEXT NULL,
    `dropzone` TEXT NULL,
    `ignored_if_empty` tinyint(1) DEFAULT 1,
    `accept_zero_value` TINYINT(1) DEFAULT 0,
...
$sql[] = 'CREATE TABLE IF NOT EXISTS `' . _DB_PREFIX_ . 'configurator_step_option` (
    ...
    `is_special_text` tinyint(1) DEFAULT 0,
    `special_text_template` VARCHAR(256) NULL,
    ...
    `option_min_qty` TEXT NULL,
    `option_max_qty` TEXT NULL,
...
$sql[] = 'CREATE TABLE IF NOT EXISTS `' . _DB_PREFIX_ . 'configurator_cart_detail` (
    ...
    `delivery_impact` INT(10) NOT NULL,
