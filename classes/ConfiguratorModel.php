    ...
    class ConfiguratorModel extends ObjectModel
    {
        ...
        public static $definition = [
            ...
            'fields' => [
                ...
                'id_customization_field' => ['type' => self::TYPE_INT, 'validate' => 'isUnsignedId'],
                'use_base_price' => ['type' => self::TYPE_BOOL, 'validate' => 'isBool'],
                'hide_qty_product' => ['type' => self::TYPE_BOOL, 'validate' => 'isBool'],
                'tab_type' => ['type' => self::TYPE_STRING, 'validate' => 'isString'],
                'use_combination' => ['type' => self::TYPE_BOOL, 'validate' => 'isBool'],
                // Module Viewer 2D
                'visual_rendering' => ['type' => self::TYPE_BOOL, 'validate' => 'isBool'],
                'hide_product_price' => ['type' => self::TYPE_INT],
                'hide_button_add_to_cart' => ['type' => self::TYPE_INT],
                'tab_force_require_step' => ['type' => self::TYPE_INT],
            ],
        ];
        ...
        public function checkCustomizationField()
        {
            ...
            if ($this->active && !Validate::isLoadedObject($customization_field)) {
                ...
                $customization_field->name = Configuration::getConfigInMultipleLangs('CONFIGURATOR_CUSTOMIZATION_FIELD_NAME');
