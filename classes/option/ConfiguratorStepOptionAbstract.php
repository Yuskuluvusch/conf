...
if (!class_exists('ConfiguratorStepOptionAbstract')) {
    ...
    class ConfiguratorStepOptionAbstract extends ObjectModel
    {
         ...
         */
        public const IMPACT_TYPE_PERCENT = 'percent';
        public const IMPACT_TYPE_NEGATIVE_PERCENT = 'neg_percent';
        public const IMPACT_TYPE_AMOUNT = 'amount';
        public const IMPACT_TYPE_REDUCTION_AMOUNT = 'reduction';
        public const IMPACT_TYPE_AREA = 'area';
        public const IMPACT_TYPE_AREA_MULTIPLE = 'area_multiple';
        public const IMPACT_TYPE_PRICELIST = 'pricelist';
        public const IMPACT_TYPE_PRICELIST_QUANTITY = 'pricelist_quantity';
        public const IMPACT_TYPE_PRICELIST_MULTIPLE = 'pricelist_multi';
        public const IMPACT_TYPE_PRICELIST_AREA = 'pricelist_area';
        public const IMPACT_TYPE_PRICELIST_AREA_SQUARE = 'pricelist_area_square';
        public const IMPACT_TYPE_MULTIPLIER = 'multiplier';
        public const IMPACT_TYPE_MULTIPLIER_PRICE = 'multiplier_price';
        public const IMPACT_TYPE_NEGATIVE_MULTIPLIER = 'neg_multiplier';
        public const IMPACT_TYPE_AMOUNT_FORMULA = 'amount_formula';
        public const IMPACT_TYPE_AMOUNT_PERIOD = 'amount_period';

        public const PRICE_CALCULATION_TYPE_WITH_REDUC = 'with_reduc';
        public const PRICE_CALCULATION_TYPE_WITHOUT_REDUC = 'without_reduc';
        ...
        public static $definition = [
            ...
            'fields' => [
                ...
                'id_option' => ['type' => self::TYPE_INT, 'validate' => 'isUnsignedId', 'required' => true],
                'ipa' => ['type' => self::TYPE_INT, 'validate' => 'isUnsignedId', 'required' => true],
                'id_configurator_step_option_division' => [
                    'type' => self::TYPE_INT,
                    'validate' => 'isNullOrUnsignedId',
                ],
                'impact_type' => ['type' => self::TYPE_STRING, 'required' => true, 'size' => 50],
                'impact_value' => ['type' => self::TYPE_FLOAT, 'validate' => 'isFloat'],
                'impact_value_period' => ['type' => self::TYPE_STRING, 'validate' => 'isString'],
                'impact_step_id' => ['type' => self::TYPE_INT, 'validate' => 'isNullOrUnsignedId'],
                'id_impact_step_option_x' => ['type' => self::TYPE_INT, 'validate' => 'isNullOrUnsignedId'],
                'id_impact_step_option_y' => ['type' => self::TYPE_INT, 'validate' => 'isNullOrUnsignedId'],
                'impact_multiple_step_id' => ['type' => self::TYPE_STRING, 'required' => false, 'size' => 250],
                'price_list' => ['type' => self::TYPE_HTML, 'validate' => 'isCleanHtml'],
                'unity' => ['type' => self::TYPE_STRING, 'size' => 10],
                'conversion_factor' => ['type' => self::TYPE_FLOAT, 'validate' => 'isFloat'],
                'selected_by_default' => ['type' => self::TYPE_BOOL, 'validate' => 'isBool'],
                'reference' => ['type' => self::TYPE_STRING, 'validate' => 'isString'],
                'reference_position' => ['type' => self::TYPE_INT, 'validate' => 'isUnsignedId'],
                'default_value' => ['type' => self::TYPE_STRING, 'validate' => 'isString'],
                'force_value' => ['type' => self::TYPE_BOOL, 'validate' => 'isBool'],
                'check_value' => ['type' => self::TYPE_BOOL, 'validate' => 'isBool'],
                'min_value' => ['type' => self::TYPE_STRING, 'validate' => 'isString'],
                'min_value_if_null' => ['type' => self::TYPE_STRING, 'validate' => 'isString'],
                'max_value' => ['type' => self::TYPE_STRING, 'validate' => 'isString'],
                'max_value_if_null' => ['type' => self::TYPE_STRING, 'validate' => 'isString'],
                'weight' => ['type' => self::TYPE_STRING, 'validate' => 'isString'],
                'delivery_impact' => ['type' => self::TYPE_STRING, 'validate' => 'isString'],
                'price_calculation' => ['type' => self::TYPE_STRING, 'required' => true, 'size' => 100],
                'display_price_calculation' => ['type' => self::TYPE_STRING, 'required' => true, 'size' => 100],
                'position' => ['type' => self::TYPE_INT],
                'impact_formula' => ['type' => self::TYPE_STRING, 'validate' => 'isString'],
                'used_for_dimension' => ['type' => self::TYPE_STRING, 'validate' => 'isString'],
                'dimension_coeff' => ['type' => self::TYPE_FLOAT, 'validate' => 'isFloat'],
                'qty_coeff' => ['type' => self::TYPE_INT, 'validate' => 'isUnsignedId'],
                'default_qty' => ['type' => self::TYPE_STRING, 'validate' => 'isString'],
                'option_min_qty' => ['type' => self::TYPE_STRING, 'validate' => 'isString'],
                'option_max_qty' => ['type' => self::TYPE_STRING, 'validate' => 'isString'],
                'slider' => ['type' => self::TYPE_BOOL, 'validate' => 'isBool'],
                'slider_step' => ['type' => self::TYPE_INT],
                'textarea' => ['type' => self::TYPE_BOOL, 'validate' => 'isBool'],
                'email' => ['type' => self::TYPE_BOOL, 'validate' => 'isBool'],
                'is_date' => ['type' => self::TYPE_BOOL, 'validate' => 'isBool'],
                'id_tax_rules_group_product' => ['type' => self::TYPE_INT, 'validate' => 'isNullOrUnsignedId'],
                'is_special_text' => ['type' => self::TYPE_BOOL, 'validate' => 'isBool'],
                'special_text_template' => ['type' => self::TYPE_STRING, 'validate' => 'isString'],
                'is_ralstep' => ['type' => self::TYPE_BOOL, 'validate' => 'isBool'],
                'id_atribute_ral' => ['type' => self::TYPE_INT, 'validate' => 'isUnsignedId', 'required' => true],
                'id_step_impact_qty' => ['type' => self::TYPE_INT, 'validate' => 'isUnsignedId'],
                'id_step_option_impact_qty' => ['type' => self::TYPE_INT, 'validate' => 'isUnsignedId'],
                'price_list_coeff' => ['type' => self::TYPE_FLOAT, 'validate' => 'isFloat'],

                /* Lang fields */
                'content' => ['type' => self::TYPE_HTML, 'lang' => true, 'validate' => 'isCleanHtml'],
                'placeholder' => ['type' => self::TYPE_STRING, 'lang' => true, 'validate' => 'isCleanHtml'],
            ],
        ];
        ...
        public function getDefaultValue()
        {
            ...
            Hook::exec('configuratorActionStepOptionGetDefaultValue', [
        ...
        public function addTaxes(&$optionDetail, $idTaxRulesGroupProduct)
        {
            ...
            if (Validate::isLoadedObject($this->getStep()->getConfigurator())) {
                ...
                } elseif (isset($optionDetail['price']['tax_incl']) && $optionDetail['price']['tax_incl'] != 0) {
